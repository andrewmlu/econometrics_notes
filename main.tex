...
\usepackage[paperwidth=8.5in, paperheight=120in, margin=1.5in]{geometry}
...
\begin{gather}
    e = y - \hat{y}
\end{gather}
where $e$ is the residual, $y$ is the actual value, and $\hat{y}$ is the predicted value. \\[0.5cm]
...
\begin{align}
    1.& \sum_{i=1}^{n} \bar{u}_i = 0 \\
    2.& \sum_{i=1}^{n} x_i \bar{u}_1 = 0 \\
...
\end{gather}
where $R^2$ is the coefficient of determination and a larger $R^2$ indicates regression explains variation well.
