...
\usepackage[paperwidth=8.5in, paperheight=200in, margin=1.5in]{geometry}
...
Autoregressive model: model that regresses on itself \\
...
Partial autocorrelation function: controls effect of intervening lags, non-zero values up to the order of the autocorrelation

\subsubsection{Moving Average Processes}
Moving average: model that regresses on current and past errors 
\begin{gather}
